export const Pagination: React.FC<{ currentPage: number, totalPages: number, paginate: any }> = (props) => {
    ...
    if (props.currentPage === 1) {
        ...
        if (props.totalPages >= props.currentPage + 1) pageNumbers.push(props.currentPage + 1);
        if (props.totalPages >= props.currentPage + 2) pageNumbers.push(props.currentPage + 2);
        ...
        <nav aria-label="...">
            <ul className="pagination">
                ...
                {pageNumbers.map(number => (
                    <li className={"page-item" + (props.currentPage === number ? "active" : "")} onClick={() => { props.paginate(number) }}>
