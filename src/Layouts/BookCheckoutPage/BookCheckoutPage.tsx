...
export const BookCheckoutPage = () => {
    ...
    useEffect(() => {
        const fetchBookReviews = async () => {
            const reviewUrl: string = `http://localhost:8080/api/books/${bookId}/reviews`;
            ...
            for (const key in responseData) { //We want to rate the first 20 books.
                loadedReviews.push({
                ...
                if (loadedReviews) { //To get the average stars rounded to the nearest .5 .
